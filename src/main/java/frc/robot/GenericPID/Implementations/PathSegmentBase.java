...
public abstract class PathSegmentBase {
    ...
    public PathSegmentBase chopEnd(double x) {
        ...
        //  /
        // |_ _ _ _|x
        var s = duplicateWithSuperCopyConstructor();
        s.x2 = x;
        return s;
    }
    ...
    private PathSegmentBase duplicateWithSuperCopyConstructor() {
        try {
            ...
            e.printStackTrace(); //constructor doesnt exist, should just be a compile error, but can't be
            return null;
        }
    }
}