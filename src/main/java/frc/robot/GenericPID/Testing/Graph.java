...
import frc.robot.GenericPID.ApproximationUtils.Functions;
...
public class Graph extends JPanel {
    ...
    public static void test1() {
        ...
        example.init(1920, 1080, "Graph"); //TODO: Address that this doesn't include the head of the graph
    }
    public static void test2() {
        ...
        for (int i = 0; i < 7; i++) {
            example.addPlot(Color.RED);//colors[i]);
