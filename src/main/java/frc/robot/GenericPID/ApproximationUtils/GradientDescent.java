...
import frc.robot.GenericPID.Extensible.PairFunction;
import frc.robot.GenericPID.Implementations.Match;
import frc.robot.GenericPID.Implementations.NoInjection;
import frc.robot.GenericPID.Implementations.NoJump;
...
public class GradientDescent {
    ...
    public static void test() {
        ...
        double xh = 2;
        double xw = 0.25;
        //for alpha descent, the constraints of this function are tight. highest gap d/dt ratio is like
        ...
        }*/, dtraversabledr, 100, 5, 0.001, 0.1);
        class heheint {
            public int n = 0;
        ...
        heheint n = new heheint();
        hehedouble lastX = new hehedouble();
        double start = 0;
        g.init(1600, 900, "descent!");
        Descent d = gd.descend(0, new DescentInjectionClosure() {
    ...
    */
     ...
     */
    public Descent descend(double startX, DescentInjectionClosure injection) {
        //todo
        ...
        } else {//if (derivativeMethod == DerivativeMethod.ESTIMATE)
            d = new Zero(); //poopy
            //todo, or todo remove
        }
        ...
        if (endMethod == EndMethod.DEADLINE) {
            ...
            return descent;
        } else { //if (endMethod == EndMethod.CUTOFF)
            Descent descent = new Descent();
            int i = 0;
