...
public class GenerateTrajectoryFromFile {
    ...
    public Trajectory generateTrajectory(
        ...
        Path traj_path = Filesystem
            .getDeployDirectory()
            .toPath()
            .resolve(file_path);
        TrajectoryGenerator.ControlVectorList controlVectors = WaypointParser.getControlVectors(
            traj_path
        );
    ...
    public static TrajectoryConfig createTrajConfig(
        double maxSpeed,
        double maxAccel,
        double initSpeed,
        double finalSpeed,
